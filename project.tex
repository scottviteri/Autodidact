...
\For{$k = 1, 2, \ldots$} \textcolor{gray}{\textit{// Main loop}}
    ...
    \State $V_{k} \gets \beta \log \sum_{a'} \exp\bigl(\bar{q}_k[a'] / \beta\bigr)$ \Comment{Soft value from target network}
